...
/*
	SET
  - held in clock mode - ALARM setting
    - held in the alarm clock setting mode - clock setting
    - double click in alarm mode - go back to the clock
    - kept in the clock setting - return to the clock with a new time
    - click during setup - change the hour / minute setting
  ALARM - on / off alarm clock
*/
// ************************** НАСТРОЙКИ **************************
